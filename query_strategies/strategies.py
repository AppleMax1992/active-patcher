...
from active_patcher.query_strategies.exceptions import EmptyPoolException, PoolExhaustedException
...
class QueryStrategy(ABC):
    ...
    def query(self, clf, dataset, indices_unlabeled, indices_labeled, y, n=10):
        ...
        Parameters
        ----------
        clf : active_patcher.classifiers.Classifier
            A text classifier.
...
class DiscriminativeActiveLearning(QueryStrategy):
    ...
    def __init__(self, classifier_factory, num_iterations, unlabeled_factor=10, pbar='tqdm'):
        """
        classifier_factory : active_patcher.
...
class SEALS(QueryStrategy):
    ...
    def __init__(self, base_query_strategy, k=100, hnsw_kwargs=dict(), embed_kwargs=dict(),
                 normalize=True):
        """
        base_query_strategy : active_patcher.query_strategy.QueryStrategy
