...
from active_patcher.classifiers.classification import EmbeddingMixin
from active_patcher.integrations.pytorch.exceptions import PytorchNotFoundError
from active_patcher.utils.classification import get_splits
from active_patcher.utils.context import build_pbar_context
from active_patcher.utils.data import check_training_data, list_length
from active_patcher.utils.datetime import format_timedelta
from active_patcher.utils.annotations import (
    early_stopping_deprecation_warning,
    model_selection_deprecation_warning
)
from active_patcher.utils.labels import get_num_labels
from active_patcher.utils.logging import verbosity_logger, VERBOSITY_MORE_VERBOSE
from active_patcher.utils.system import get_tmp_dir_base
...
try:
    ...
    from active_patcher.integrations.pytorch.utils.data import dataloader
    from active_patcher.integrations.pytorch.utils.misc import enable_dropout
    from active_patcher.integrations.transformers.classifiers.base import (
        ModelLoadingStrategy
    )
    from active_patcher.integrations.transformers.datasets import TransformersDataset
    from active_patcher.integrations.transformers.utils.classification import (
