...
from active_patcher.base import check_optional_dependency
from active_patcher.classifiers.classification import Classifier, EmbeddingMixin
from active_patcher.exceptions import UnsupportedOperationException

from active_patcher.utils.classification import (
    empty_result,
    _multi_label_list_to_multi_hot,
    prediction_result
)
from active_patcher.utils.context import build_pbar_context
from active_patcher.utils.labels import csr_to_list
from active_patcher.utils.numpy import int_dtype
...
try:
    ...
    from active_patcher.integrations.transformers.utils.setfit import (
        _check_model_kwargs,
