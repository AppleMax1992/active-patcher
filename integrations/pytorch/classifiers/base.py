...
from active_patcher.classifiers.classification import Classifier
...
from active_patcher.training.model_selection import ModelSelection, NoopModelSelection
from active_patcher.utils.classification import empty_result, prediction_result
...
try:
    ...
    from active_patcher.integrations.pytorch.utils.loss import _LossAdapter2DTo1D
except ImportError:
...
class PytorchClassifier(PytorchModelSelectionMixin, Classifier):
    ...
    def predict(self, data_set, return_proba=False):
        ...
        Parameters
        ----------
        data_set : active_patcher.data.Dataset
