...
from active_patcher.base import LABEL_UNLABELED
from active_patcher.data import DatasetView
from active_patcher.data.datasets import check_size, check_target_labels, get_updated_target_labels
from active_patcher.data.exceptions import UnsupportedOperationException
from active_patcher.utils.annotations import experimental
from active_patcher.utils.labels import csr_to_list, get_num_labels, list_to_csr
...
class PytorchTextClassificationDataset(PytorchDataset):
    ...
    def __init__(self, data, vocab, multi_label=False, target_labels=None):
        ...
        data : list of tuples (text data [Tensor], labels [int or list of int])
            ...
            instances the label should be set to active_patcher.base.LABEL_UNLABELED`,
