...
from active_patcher.data.sampling import balanced_sampling
from active_patcher.data.sampling import multilabel_stratified_subsets_sampling
from active_patcher.data.sampling import stratified_sampling
...
def random_initialization_stratified(y, n_samples=10, multilabel_strategy='labelsets'):
    ...
    See Also
    --------
    active_patcher.data.sampling.multilabel_stratified_subsets_sampling : Details on the `labelsets`
